          ...
          <div className="grid grid-cols-1 gap-4">
            {sorted.map((order) => (
              ...
              >
                ...
                {/* Items */}
                <div className="mt-3 flex gap-3 overflow-x-auto sm:overflow-x-visible sm:flex-wrap">
                ...
                <div className="mt-3 flex items-center justify-between">
                  <div className="text-sm">
                    Total:{" "}
                    <span className="font-medium">₹{order.total}.00</span>
                  </div>
                  <button
                    className="text-sm text-fashion-purple"
